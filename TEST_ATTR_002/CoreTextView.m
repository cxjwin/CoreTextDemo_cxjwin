...
NSString *const kCoreTextViewWillDisappear = @"kCoreTextViewWillDisappear";
...
- (void)dealloc  {
	[[NSNotificationCenter defaultCenter] removeObserver:self name:kCoreTextViewWillDisappear object:nil];
...
- (void)initCommon {
	...
	_adjustWidth = CGRectGetWidth(self.frame);
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(coreTextViewWillDisappear:) name:kCoreTextViewWillDisappear object:nil];
}
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	CGPoint mirrorPoint = CGPointFlipped(point, CGRectMake(0, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame)));
...
- (void)coreTextViewWillDisappear:(NSNotification *)notification {
	//
}
